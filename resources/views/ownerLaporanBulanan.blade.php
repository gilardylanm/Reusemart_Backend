...
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-10 main-content">
                ...
                <div id="requestsSection" class="content-section">
                    ...
                    <form method="GET" action="{{ route('laporan.perbulan') }}" class="mb-3 d-flex align-items-center">
                        <label for="tahun" class="me-2">Pilih Tahun:</label>
                        <select name="tahun" id="tahun" class="form-select w-auto me-2" onchange="this.form.submit()">
                    ...
                    <!-- Tombol cetak -->
                    <div class="mb-3">
                        <a href="{{ route('laporanBulanan.cetak', ['tahun' => $tahunDipilih]) }}" class="btn btn-primary">Cetak PDF</a>
                    </div>
    ...
    <script>
        ...
        const chart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: {!! json_encode(array_column($laporan, 'total_penjualan')) !!},
        ...
        function prepareImage() {
            ...
            document.getElementById('grafik_base64').value = base64;
        }
    </script>
