        ...
        <div class="row">
            ...
            <div class="col-md-10 main-content">
                ...
                <div id="requestsSection" class="content-section">
                    <h2 class="section-title">Laporan Komisi Produk</h2>

                    <!-- Tombol cetak -->
                    <div class="mb-3">
                        <a href="{{ route('laporanKomisi.cetak') }}" class="btn btn-primary" target="_blank">
                            Cetak Nota
                        </a>
                    </div>
                        ...
                        <table class="table table-striped table-hover">
                            <thead>
                                <tr class="table-header">
                                    ...
                                    <th scope="col">Tanggal Laku</th>
                                    <th scope="col">Komisi Hunter</th>
                                    <th scope="col">Komisi ReuseMart</th>
                                    <th scope="col">Bonus Penitip</th>
                                </tr>
                            </thead>
                            <tbody id="requestsTableBody">
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>Rp {{ number_format($item->KOMISI_HUNTER, 0, ',', '.') }}</td>
                                        <td>Rp {{ number_format($item->KOMISI_REUSEMART, 0, ',', '.') }}</td>
                                        <td>Rp {{ number_format($item->BONUS_PENITIP, 0, ',', '.') }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
